...
namespace Algebras.Localization.Editor.Extension
{
    ...
    {
        [SerializeField] private AlgebrasServiceProvider serviceProvider;

        [SerializeField] private AlgebrasTableSettings tableSettings = new();
    ...
    {
        [SerializeField]
        [Tooltip("Translation mode: Batch (faster, no glossary) or Single (slower, supports glossary)")]
        private TranslationMode translationMode = TranslationMode.Batch;

        [SerializeField]
        [Tooltip("Remove escaped characters like \\n, \\' from translations when they weren't in the source")]
        private bool normalizeStrings = true;

        [SerializeField]
        [Tooltip("UI-safe mode: ensures translations won't be longer than original text (good for buttons, labels)")]
        private bool uiMode;

        [SerializeField]
        [TextArea(3, 10)]
        [Tooltip(
            "Custom instructions for the AI translator specific to this table (e.g., 'Use formal tone for UI buttons')")]
        ...
        [SerializeField]
        [Tooltip("Source language for translation. 'Auto' lets the AI detect the language automatically")]
        private string sourceLanguage = "Auto";

        [SerializeField]
        [Tooltip("Target languages to translate into. Leave empty to translate to all available languages")]
        ...
        /// </summary>
        public bool NormalizeStrings
        {
            get => normalizeStrings;
            set => normalizeStrings = value;
        }
        ...
        {
            get => customPrompt;
            set => customPrompt = value ?? string.Empty;
        }
        ...
        {
            get => glossaryId;
            set => glossaryId = value ?? string.Empty;
        }
        ...
        {
            get => targetLanguages;
            set => targetLanguages = value ?? new string[0];
        }
    }
}