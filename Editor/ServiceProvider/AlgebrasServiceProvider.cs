...
namespace Algebras.Localization.Editor
{
    ...
    {
        [SerializeField, Tooltip("Controls randomness in translation (0-1). Lower values = more consistent. OpenAI only."), Range(0f, 1f)]
        private float temperature = 0.3f;

        [SerializeField, Tooltip("Maximum tokens for AI response. Higher = longer translations possible. OpenAI only."), Range(1, 4096)]
        ...
        /// </summary>
        public float Temperature { get => temperature; set => temperature = Mathf.Clamp01(value); }
    ...
    public class AlgebrasBatchSettings
    {
        ...
        [SerializeField, Tooltip("Maximum number of simultaneous batch requests for better performance"), Range(1, 10)]
        ...
        /// </summary>
        public int BatchSize { get => batchSize; set => batchSize = Mathf.Max(1, value); }

        /// <summary>
        /// Maximum number of parallel batch requests.
        /// </summary>
        public int MaxParallelBatches { get => maxParallelBatches; set => maxParallelBatches = Mathf.Max(1, value); }

        /// <summary>
        /// Delay between requests to respect rate limits (seconds).
        /// </summary>
        public float RequestDelay { get => requestDelay; set => requestDelay = Mathf.Max(0f, value); }
    }
    ...
    public class AlgebrasServiceProvider : ScriptableObject, IAlgebrasTranslationService, ISerializationCallbackReceiver
    {
        ...
        [SerializeField] private AlgebrasAPISettings apiSettings = new AlgebrasAPISettings();
        [SerializeField] private AlgebrasBatchSettings batchSettings = new AlgebrasBatchSettings();
